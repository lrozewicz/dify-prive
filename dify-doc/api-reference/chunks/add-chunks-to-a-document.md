...
````yaml en/openapi_knowledge.json post /datasets/{dataset_id}/documents/{document_id}/segments
paths:
                    ...
                    items:
                      ...
                      properties:
                        content:
                          type: string
                          description: >-
                            The text content of the chunk (or question in Q&A
                            mode).
                        answer:
                          type: string
                          description: >-
                            The answer content, required if the document is in
                            Q&A mode.
                        keywords:
                          type: array
