...
[Edit this page](https://github.com/langgenius/dify-docs/edit/main/en/getting-started/install-self-hosted/start-the-frontend-docker-container.mdx) | [Report an issue](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)
